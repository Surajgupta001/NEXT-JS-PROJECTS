...
export default function DeleteLesson({ chapterId, lessonId, courseId }: { chapterId: string, lessonId: string, courseId: string }) {
    ...
    async function onSubmit() {
        startTransition(async () => {
            const { data: result, error } = await tryCatch(deleteLesson({ chapterId, lessonId, courseId }))
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        {' '}
                        This action cannot be undone. This will permanently delete the lesson and remove it from your course.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
