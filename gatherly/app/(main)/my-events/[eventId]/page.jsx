...
import { ArrowLeft, Calendar, MapPin, Users, TrendingUp, Clock, Trash2, QrCode, Loader2, CheckCircle, Download, Search, Eye } from "lucide-react";
    ...
    return (
        <div className="min-h-screen px-4 pb-20">
            <div className="mx-auto max-w-7xl">
                ...
                {/* Event Header */}
                <div className="flex flex-col items-start justify-between gap-5 mb-4 sm:flex-row">
