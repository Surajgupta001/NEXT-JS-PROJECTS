...
function CreateEventPage() {
    ...
    return (
        <div
            className="min-h-screen px-6 py-8 -mt-6 transition-colors duration-300 md:-mt-16 lg:-mt-5 lg:rounded-md"
            style={{ backgroundColor: themeColor }}
        >
            {/* Header */}
            <div className="flex flex-col justify-between max-w-6xl gap-5 mx-auto mb-10 md:flex-row">
                <div>
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-[320px_1fr] gap-10">
                ...
                <div className="space-y-6">
                    <div
                        className="flex items-center justify-center w-full overflow-hidden border cursor-pointer aspect-square rounded-xl"
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            {!hasPro && (
                                <button
                                    ...
                                    className="flex items-center justify-center w-10 h-10 transition-colors border-2 border-purple-300 border-dashed rounded-full hover:border-purple-500"
