...
import { Calendar, MapPin, Users, Clock, Share2, Ticket, ExternalLink, Loader2, CheckCircle } from "lucide-react";
    ...
    return (
        ...
        >
            <div className="px-8 mx-auto max-w-7xl">
                ...
                {/* Hero Image */}
                {event.coverImage && (
                    <div className="relative mb-6 overflow-hidden h-100 rounded-2xl">
                        <Image
                    ...
                    <div className="lg:sticky lg:top-24 h-fit">
                        ...
                        >
                            <CardContent className="p-6 space-y-4">
                                ...
                                {registration ? (
                                    <div className="space-y-3">
                                        <div className="flex items-center gap-2 p-3 text-green-600 rounded-lg bg-green-50">
