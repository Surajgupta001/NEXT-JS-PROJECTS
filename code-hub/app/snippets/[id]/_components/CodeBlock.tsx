...
const CodeBlock = ({ language, code }: { language: string; code: string }) => {
    ...
    // Get logo path safely from constants or fallback to dynamic svg path
    const logoSrc = LANGUAGE_CONFIG[language.toLowerCase()]?.logoPath || `/${language.toLowerCase()}.svg`;
