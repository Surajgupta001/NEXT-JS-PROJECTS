            ...
            <div className="relative px-4 py-12 mx-auto max-w-7xl">
             ...
             from-blue-500/10 to-purple-500/10 text-sm text-gray-400 mb-6"
                    ...
                    <motion.h1
                        ...
                        className="mb-6 text-4xl font-bold text-transparent md:text-5xl bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text"
                    >
                ...
                <div className="relative max-w-5xl mx-auto mb-12 space-y-6">
                    ...
                    <div className="relative group">
                        <div className="absolute inset-0 transition-all duration-500 opacity-0 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-xl blur-xl group-hover:opacity-100" />
                  ...
                  `}
                            >
                                <div className="flex items-center gap-2">
                                    <img src={`/${lang}.svg`} alt={lang} className="object-contain w-4 h-4" />
                ...
                {filteredSnippets.length === 0 && (
                    <motion.div
                        ...
                        className="relative max-w-md p-8 mx-auto mt-20 overflow-hidden rounded-2xl"
                    >
                        <div className="text-center">
                            <div
                                className="inline-flex items-center justify-center w-16 h-16 mb-6 rounded-2xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 ring-1 ring-white/10"
                            >
                                <Code className="w-8 h-8 text-gray-400" />
                            </div>
                            <h3 className="mb-3 text-xl font-medium text-white">No snippets found</h3>
