                ...
                <div
                    ...
                    {isRunning ? (
                        ...
                        <div className="flex items-start gap-3 text-red-400">
                            <AlertTriangle className="flex-shrink-0 w-5 h-5 mt-1" />
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-gray-500">
                            <div className="flex items-center justify-center w-12 h-12 mb-4 rounded-xl bg-gray-800/50 ring-1 ring-gray-700/50">
