    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <motion.button
                ...
                {/* Decoration */}
                <div className="absolute inset-0 transition-opacity rounded-lg opacity-0 bg-gradient-to-r from-blue-500/10 to-purple-500/5 group-hover:opacity-100" aria-hidden="true" />
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        <div className="max-h-[280px] overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:hidden [scrollbar-width:none] [-ms-overflow-style:none]">
                                    ...
                                    >
                                        <button
                                            ...
                                            <div
                                                ...
                                                <div className="absolute inset-0 transition-opacity rounded-lg opacity-0 bg-gradient-to-br from-blue-500/10 to-purple-500/10 group-hover:opacity-100" />
                                                <Image
                                                    width={24}
                                                    height={24}
                                                    src={lang.logoPath}
