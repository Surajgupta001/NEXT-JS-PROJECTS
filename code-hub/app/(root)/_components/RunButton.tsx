...
function RunButton() {
    ...
    return (
        ...
        >
            {/* bg wit gradient */}
            <div className="absolute inset-0 transition-opacity opacity-100 bg-gradient-to-r from-blue-600 to-blue-500 rounded-xl group-hover:opacity-90" />
                ...
                {isRunning ? (
                    ...
                    <>
                        <div className="relative flex items-center justify-center w-4 h-4">
                            <Play className="w-4 h-4 transition-transform text-white/90 group-hover:scale-110 group-hover:text-white" />
                        </div>
