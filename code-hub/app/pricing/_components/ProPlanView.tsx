        ...
        <div className=" bg-[#0a0a0f]">
            ...
            <div className="relative px-4 h-[80vh] flex items-center justify-center">
                <div className="relative max-w-xl mx-auto text-center">
                    <div className="absolute inset-x-0 h-px -top-px bg-gradient-to-r from-transparent via-blue-500/50 to-transparent" />
                    ...
                    <div className="relative bg-[#12121a]/90 border border-gray-800/50 backdrop-blur-2xl rounded-2xl p-12">
                        ...
                        <div className="relative">
                            <div className="inline-flex p-4 mb-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-blue-500/10 ring-1 ring-gray-800/60">
                                <Star className="w-8 h-8 text-purple-400" />
                            </div>

                            <h1 className="mb-3 text-3xl font-semibold text-white">Pro Plan Active</h1>
                            ...
                            <Link
                                href="/"
                                className="inline-flex items-center justify-center w-full gap-2 px-8 py-4 text-white transition-all duration-200 border border-gray-800 bg-gradient-to-r from-blue-500/10 to-purple-500/10 hover:from-blue-500/20 hover:to-purple-500/20 rounded-xl hover:border-blue-500/50 group"
                            >
